...
using System.Data;
public partial class TPO_reg : System.Web.UI.Page
{
    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
        ...
        if (FileUpload2.HasFile)
        {
            ...
            if (matchExtension.Contains(fileExtension) && matchMimeType.Contains(fileMimeType))
            {
                ...
                {
                    FileUpload2.SaveAs(Server.MapPath(@"Pic/" + fileName));
                    string file_path = "~/Pic/" + fileName;
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        {
            string query = "insert into tpo values('" + TextBox2.Text + "','" + TextBox3.Text + "','" + TextBox1.Text + "','" + TextBox5.Text + "','" + TextBox8.Text + "','" + TextBox6.Text + "','" + TextBox7.Text + "')";
